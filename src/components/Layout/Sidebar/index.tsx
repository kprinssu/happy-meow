...
import { faDisplay, faKeyboard, faGear } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className="sidebar text-white">
      <ul>
        ...
        <li className="sidebar-item hover:text-gray-400 ml-2 mt-3"><Link to="/settings"><FontAwesomeIcon icon={faGear} className="sidebar-icon" /></Link></li>
      </ul>
    </div>
  );
};
