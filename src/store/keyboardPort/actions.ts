...
import { ParsedConfig, Cyberboard } from '../../keyboard/parser';
...
export const syncKeyboard = (selectedPort: PortInfo, displayLayers: KeyboardDisplayState, keyboardLedLayers: KeyboardLedState, keyboardKeyLayers: KeyboardKeyState): ThunkAction<void, RootState, unknown, AnyAction> => {
  return async (dispatch) => {
